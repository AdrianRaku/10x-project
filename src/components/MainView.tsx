      ...
      <div className="space-y-2 text-center">
        ...
        {hasUnlockedRecommendations ? (
          <p className="text-muted-foreground" data-test-id="ratings-count-message">
            Masz już{" "}
            <span className="font-semibold text-foreground" data-test-id="ratings-count">
              {ratingsCount}
            </span>{" "}
            ocenionych filmów
          </p>
          ...
          <div className="space-y-2">
            <p className="text-muted-foreground" data-test-id="recommendations-locked-message">
              Oceń co najmniej{" "}
              <span className="font-semibold text-foreground" data-test-id="ratings-threshold">
                {ratingsThreshold}
              </span>{" "}
              filmów, aby odblokować spersonalizowane rekomendacje AI
            </p>
          ...
          <div className="flex items-center gap-2">
            ...
            {ratingsCount === ratingsThreshold && (
              <span
                ...
                data-test-id="recommendations-new-badge"
              >
                Nowe!
              </span>
            )}
          ...
          {recommendations.length > 0 && (
            <div className="space-y-4" data-test-id="recommendations-results">
              ...
              <div
                ...
                data-test-id="recommendations-list"
              >
