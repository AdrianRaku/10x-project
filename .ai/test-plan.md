...
*   **AI (LLM):** Testowanie deterministyczne jest trudne. Należy skupić się na testowaniu *formatu* odpowiedzi (schema validation zaimplementowana w `RecommendationsService`) oraz obsługi błędów, a nie samej "jakości" rekomendacji artystycznych.
...
6.  **Priorytetyzacja:**
    *   *P0 (Critical):* Blokuje główny proces (Logowanie, Ocenianie).
    *   *P1 (High):* Poważny błąd funkcjonalny (Brak zapisu oceny, błąd AI).
    *   *P2 (Medium):* Błąd UI/UX, literówki, błędy brzegowe.
